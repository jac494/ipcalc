...
def print_output(None) -> None:
    ...
    for key in INPUT_KEYS:
        ...
        print('| ' + str(NETWORK_DATA_DICT[key][1]) + ' '*(table_len-data_len-4) + str(NETWORK_DATA_DICT[key][0]) + ' |')
    print('='*table_len + '\n| Output Data:' + ' '*(table_len-15) +  '|')
    print('| ' + '-'*(table_len-4) + ' |')
    for key in OUTPUT_KEYS:
        data_len = len(str(NETWORK_DATA_DICT[key][1])) + len(str(NETWORK_DATA_DICT[key][0]))
        print('| ' + str(NETWORK_DATA_DICT[key][1]) + ' '*(table_len-data_len-4) + str(NETWORK_DATA_DICT[key][0]) + ' |')
    print('='*table_len + '\n\n')
